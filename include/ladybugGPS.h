...
{   
   ...
   /** Sub-second, hundredth of a second */
 ...
 *                       It should be one of "GPGGA","GPGSA","GPRMC", "GPZDA",
 *                       "GPGLL","GPVTG" or "GPGSV".
 * @param  pNMEADataBuffer   - The pointer to the data structure to receive GPS data.
 *                       The structure should be one of the following with
 *                       respect to the NMEA sentence specified above by
 *                       pszNMEASentenceId:
 *                       LadybugNMEAGPGGA, LadybugNMEAGPGSA, LadybugNMEAGPRMC,
 *                       LadybugNMEAGPZDA, LadybugNMEAGPGLL, LadybugNMEAGPVTG,
 *                       LadybugNMEAGPGSV
 *
 * @return   A LadybugError indicating the success of the function.
 *
